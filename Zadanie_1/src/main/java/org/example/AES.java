...
public class AES {
    ...
    private final int[] inverted_sbox = {0x52, 0x09, 0x6A, 0xD5, 0x30, 0x36, 0xA5,
    ...
    public byte[][] string_to_byte_blocks(String text) throws LengthException {
        ...
        if (text_length_mod_128 < 0) {
            throw new LengthException("Text length can't be 0");
        }
        if (text_length_mod_128 != 0) {
